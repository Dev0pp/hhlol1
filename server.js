...
// --- Static frontend (index + dashboard + login without changes) ---
const STATIC_DIR = path.join(__dirname, 'public');

// التوزيع الأساسي
app.use(express.static(STATIC_DIR));

// مسارات إضافية لتوافق المسارات القديمة داخل dashboard.html
...
// الصفحة الرئيسية (موقع المستندات)
